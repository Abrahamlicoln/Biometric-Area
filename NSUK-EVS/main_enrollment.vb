...
Public Class main_enrollment
    ...
    Private Sub Main_enrollment_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Not String.IsNullOrEmpty(GlobalData.PassportImageString) Then
            ...
            Dim pictureBoxSize As Size = PictureBox2.Size
        ...
        mainlabel.Text = "Welcome Back, " + Fullname
        label1.Text = "Department: " + department
    ...
    Private Sub Guna2Button2_Click(sender As Object, e As EventArgs) Handles Guna2Button2.Click
        ...
        Dim connString As String = "server=localhost;port=3306;user=root;password=;database=hostelmsphp;"
        Dim conn As New MySqlConnection(connString)
        conn.Open()

        ' Create the SQL query to insert the image data into the table
        Dim query As String = "UPDATE userregistration SET passport = @passport, status = @status WHERE regNo = @registration_number"
